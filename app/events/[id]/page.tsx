  ...
  return (
    <main className="py-24 px-2 md:px-24 w-screen">
      <div className="flex gap-2 py-12 items-center">
        <Image src={"/eventsymbol.svg"} width={70} height={70} alt="error" />
        <div>
          ...
          <h2 className="text-gray-800 text-md italic">23rd February 2023</h2>
        </div>
      </div>
      ...
      <section>
        ...
        <p className="text-md md:text-lg py-4">
          ...
          ducimus dolores! Maxime, eius. Odio, esse sint. Iure, consectetur
          voluptas? Doloribus odit eius, ut cum nemo quidem eveniet laboriosam.
          Obcaecati perspiciatis modi cum placeat architecto, nam sequi hic
          suscipit repudiandae neque reprehenderit odio praesentium?
        </p>
        <p className="text-md md:text-lg py-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum quibusdam
          ducimus dolores! Maxime, eius. Odio, esse sint. Iure, consectetur
